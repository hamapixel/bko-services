...
Les étapes 20 à 22 livrent les espaces client, prestataire et administration responsive.
...
Voir `../docs/etape-20-espace-client.md` pour le parcours client, `../docs/etape-21-espace-prestataire.md` pour le parcours prestataire et `../docs/etape-22-espace-administration.md` pour l'administration.
